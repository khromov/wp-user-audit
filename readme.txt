...
Keep track of your users password strength and remind them to set a strong password
...
Install from the WordPress plugin directory or by downloading the zip file and putting it in your /wp-content/plugins` folder.
